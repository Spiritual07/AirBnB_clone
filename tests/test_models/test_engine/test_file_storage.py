...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_reload(self):
        ...
        object = FileStorage._FileStorage__objects
        self.assertIn("BaseModel." + b.id, object)
        self.assertIn("User." + u.id, object)
        self.assertIn("State." + s.id, object)
        self.assertIn("Place." + p.id, object)
        self.assertIn("City." + c.id, object)
        self.assertIn("Amenity." + a.id, object)
        self.assertIn("Review." + r.id, object)
